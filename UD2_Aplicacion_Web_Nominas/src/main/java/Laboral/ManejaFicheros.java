...
public class ManejaFicheros {
	...
	public static void leeFicheros(File fichero, List<Empleado> empleados) throws FileNotFoundException, DatosNoCorrectosException, IOException {
	...
	public static void escribeFicheroNominas(File fichero, List<Empleado> empleados, boolean anexar, Nomina nom)
			throws IOException {
	...
	public static void escribeFicheroEmpleados(File fichero, List<Empleado> empleados, boolean anexar) throws IOException {
